...
PairStyle(mattersim, PairMatterSim)

#else

#ifndef LMP_PAIR_MATTERSIM_H_
#define LMP_PAIR_MATTERSIM_H_
...
class PairMatterSim: public Pair
{
public:
    PairMatterSim(class LAMMPS*);

    virtual ~PairMatterSim() override;
