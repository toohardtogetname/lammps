...
def mattersim_initialize(model_name = None, dftd3 = False, gpu = True):
    """
    Initialize GNNP of MatterSim.
    Args:
    ...
    # Create MatterSimCalculator, that is pre-trained
    global myCalculator
    ...
    global mattersimCalculator
    global dftd3Calculator

    mattersimCalculator = myCalculator
    ...
    if dftd3:
        ...
        myCalculator = SumCalculator([mattersimCalculator, dftd3Calculator])
    ...
    return mattersimCalculator.potential.model.model_args.get("cutoff", 5.0)

def mattersim_get_energy_forces_stress(cell, atomic_numbers, positions):
    """
    Predict total energy, atomic forces and stress w/ pre-trained GNNP of MatterSim.
    Args:
    ...
    if dftd3Calculator is None:
        ...
        myAtoms.calc = mattersimCalculator
